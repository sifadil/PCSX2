...
void IOPDumpRegs(FILE * fp)
{
	...
	for(i = 0; i < 32; i++)
	{
		sprintf(text1,"%x",iopRegs.GPR.r[i]);
		sprintf(text2,"GPR Register %d: ",i+1);
		fprintf(fp,text2);
		fprintf(fp,text1);
		fprintf(fp,"\n");
	}
	sprintf(text1,"0x%x",iopRegs.pc);
	fprintf(fp,"PC Register : ");
	fprintf(fp,text1);
	fprintf(fp,"\n");
	sprintf(text1,"%x",iopRegs.GPR.r[32]);
	fprintf(fp,"GPR Register HI: ");
	fprintf(fp,text1);
	fprintf(fp,"\n");
	sprintf(text1,"%x",iopRegs.GPR.r[33]);
	fprintf(fp,"GPR Register LO: ");
	fprintf(fp,text1);
	fprintf(fp,"\n");
}
