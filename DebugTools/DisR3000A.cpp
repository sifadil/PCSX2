...
#define dGPR(i)		sprintf(ostr, "%s %8.8lx (%s),", ostr, iopRegs.GPR.r[i], disRNameGPR[i])
#define dCP0(i)		sprintf(ostr, "%s %8.8lx (%s),", ostr, iopRegs.CP0.r[i], disRNameCP0[i])
#define dHI()		sprintf(ostr, "%s %8.8lx (%s),", ostr, iopRegs.GPR.n.hi, "hi")
#define dLO()		sprintf(ostr, "%s %8.8lx (%s),", ostr, iopRegs.GPR.n.lo, "lo")
...
#define dOfB()		sprintf(ostr, "%s %4.4lx (%8.8lx (%s)),", ostr, _Im_, iopRegs.GPR.r[_Rs_], disRNameGPR[_Rs_])
